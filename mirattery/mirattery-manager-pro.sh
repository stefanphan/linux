...
do
rsync -a $PROJ_PATH/order/target/mirattery-manager.jar root@$ip:/home/mirattery-manager.jar
...
mv $sit_path/mirattery-manager.jar $sit_path/$date.tar
mv /home/mirattery-manager.jar $sit_path
nohup java -jar /appset/mirattery/manager/mirattery-manager.jar --spring.profiles.active=prod >/dev/null  2>&1 &
exit
remotessh
done
rm -rf $PROJ_PATH
